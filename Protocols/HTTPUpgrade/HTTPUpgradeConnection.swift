...
//  Anywhere
//
//  HTTP upgrade handshake then raw TCP passthrough.
//  Unlike WebSocket, no framing is used after the HTTP 101 response.
//  Matches Xray-core's httpupgrade dialer (transport/internet/httpupgrade/dialer.go).
//
